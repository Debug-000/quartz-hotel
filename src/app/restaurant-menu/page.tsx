...
import { restaurantMenu } from "@/lib/quartz-data";

export const metadata: Metadata = {
  title: "Marlowe Grill Menu | Quartz Hotel",
  description:
    "Explore the Marlowe Grill menu at Quartz Hotel with refined starters, mains, desserts, and service details.",
};

const serviceNotes = [
  ["Lunch", "12:30 pm - 3:00 pm"],
  ["Dinner", "5:30 pm - 10:30 pm"],
  ["Reservations", "Hotel guests and outside bookings"],
            ...
            <div className="grid gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
              <div>
                ...
                <p className="mt-4 max-w-lg text-sm leading-7 text-[#4f473e] sm:text-base">
                  Seasonal plates, stronger mains, and desserts with restraint.
                </p>
              </div>
